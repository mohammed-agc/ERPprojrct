...
const PartnerBalanceSummary = lazy(() => import("./pages/accounting/PartnerBalanceSummary"));
...
const AdminSettingsZatca = lazy(() => import("./pages/admin/settings/ZatcaSettings"));
        ...
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/accounting/partner-balances" element={<PartnerBalanceSummary />} />
              ...
              <Route path="/admin" element={<AdminLayout />}>
                ...
                <Route path="settings/zatca" element={<AdminSettingsZatca />} />
